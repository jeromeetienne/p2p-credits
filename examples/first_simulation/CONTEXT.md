...
## Background
- The task types follow the example of section 2 of [the design note](../../docs/design_note.md): the reference task costs 10 seconds and is worth 1 credit, task A costs 30 seconds, and task B costs 5 seconds.
